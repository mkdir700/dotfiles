...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'nvim-lastplace', 'Comment.nvim', 'todo-comments.nvim', 'leap.nvim', 'gitsigns.nvim', 'nvim-bqf', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'toggleterm.nvim', 'dressing.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

...
vim.cmd [[au FileType python ++once lua require("packer.load")({'vim-venom', 'autoflake.vim'}, { ft = "python" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-bookmarks', 'leap.nvim', 'todo-comments.nvim', 'nvim-lastplace', 'nvim-bqf', 'fidget.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

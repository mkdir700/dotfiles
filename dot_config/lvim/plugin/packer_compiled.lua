...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'leap.nvim', 'vim-bookmarks', 'fidget.nvim', 'gitsigns.nvim', 'nvim-lastplace', 'Comment.nvim', 'todo-comments.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'bufferline.nvim', 'toggleterm.nvim', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

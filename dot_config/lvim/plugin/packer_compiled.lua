...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'fidget.nvim', 'leap.nvim', 'Comment.nvim', 'nvim-lastplace', 'gitsigns.nvim', 'nvim-bqf', 'vim-bookmarks'}, { event = "BufRead *" }, _G.packer_plugins)]]

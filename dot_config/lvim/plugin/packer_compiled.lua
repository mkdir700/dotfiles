...
_G.packer_plugins = {
  ...
  ["py_lsp.nvim"] = {
    loaded = true,
    path = "/Users/mark/.local/share/lunarvim/site/pack/packer/start/py_lsp.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'todo-comments.nvim', 'Comment.nvim', 'leap.nvim', 'vim-bookmarks', 'fidget.nvim', 'gitsigns.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'leap.nvim', 'nvim-bqf', 'Comment.nvim', 'todo-comments.nvim', 'vim-bookmarks', 'fidget.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'bufferline.nvim', 'dressing.nvim', 'toggleterm.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

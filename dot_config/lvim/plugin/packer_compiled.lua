...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'gitsigns.nvim', 'vim-bookmarks', 'nvim-lastplace', 'todo-comments.nvim', 'nvim-bqf', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'toggleterm.nvim', 'which-key.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

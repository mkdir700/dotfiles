...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'dressing.nvim', 'toggleterm.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'Comment.nvim', 'vim-bookmarks', 'nvim-lastplace', 'nvim-bqf', 'gitsigns.nvim', 'todo-comments.nvim', 'leap.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

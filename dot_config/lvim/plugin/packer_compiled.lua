...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'nvim-lastplace', 'fidget.nvim', 'nvim-bqf', 'vim-bookmarks'}, { event = "BufRead *" }, _G.packer_plugins)]]

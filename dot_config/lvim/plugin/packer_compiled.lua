...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'leap.nvim', 'vim-bookmarks', 'nvim-bqf', 'fidget.nvim', 'todo-comments.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'Comment.nvim', 'leap.nvim', 'fidget.nvim', 'nvim-lastplace', 'todo-comments.nvim', 'gitsigns.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]

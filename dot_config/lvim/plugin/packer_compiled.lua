...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'toggleterm.nvim', 'dressing.nvim', 'bufferline.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-cool', 'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'gitsigns.nvim', 'vim-bookmarks', 'nvim-bqf', 'nvim-lastplace', 'todo-comments.nvim', 'leap.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

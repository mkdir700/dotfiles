...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-bqf', 'Comment.nvim', 'vim-bookmarks', 'fidget.nvim', 'nvim-lastplace', 'leap.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

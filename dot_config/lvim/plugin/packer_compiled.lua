...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'nvim-bqf', 'todo-comments.nvim', 'Comment.nvim', 'gitsigns.nvim', 'leap.nvim', 'nvim-lastplace', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

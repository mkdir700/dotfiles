...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-lastplace', 'vim-bookmarks', 'leap.nvim', 'todo-comments.nvim', 'Comment.nvim', 'nvim-bqf', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'vim-bookmarks', 'leap.nvim', 'nvim-bqf', 'Comment.nvim', 'fidget.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]

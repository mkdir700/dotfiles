...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'leap.nvim', 'Comment.nvim', 'nvim-lastplace', 'vim-bookmarks', 'gitsigns.nvim', 'fidget.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

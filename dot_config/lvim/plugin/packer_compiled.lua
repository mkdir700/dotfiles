...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'todo-comments.nvim', 'fidget.nvim', 'Comment.nvim', 'gitsigns.nvim', 'nvim-bqf', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]

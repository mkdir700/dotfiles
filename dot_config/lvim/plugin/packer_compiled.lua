...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'Comment.nvim', 'todo-comments.nvim', 'nvim-lastplace', 'fidget.nvim', 'vim-bookmarks', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

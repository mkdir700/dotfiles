...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'gitsigns.nvim', 'Comment.nvim', 'nvim-bqf', 'vim-bookmarks', 'leap.nvim', 'todo-comments.nvim', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

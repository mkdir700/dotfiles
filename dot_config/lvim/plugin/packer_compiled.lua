...
_G.packer_plugins = {
  ...
  ["minimap.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/mark/.local/share/lunarvim/site/pack/packer/opt/minimap.vim",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'bufferline.nvim', 'toggleterm.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-bqf', 'Comment.nvim', 'gitsigns.nvim', 'leap.nvim', 'vim-bookmarks', 'fidget.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

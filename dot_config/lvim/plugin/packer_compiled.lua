...
_G.packer_plugins = {
  ...
  ["org-bullets.nvim"] = {
    ...
    loaded = true,
    path = "/Users/mark/.local/share/lunarvim/site/pack/packer/start/org-bullets.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'leap.nvim', 'Comment.nvim', 'nvim-lastplace', 'gitsigns.nvim', 'fidget.nvim', 'vim-bookmarks', 'nvim-bqf', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'leap.nvim', 'todo-comments.nvim', 'Comment.nvim', 'gitsigns.nvim', 'fidget.nvim', 'nvim-lastplace', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNew * ++once lua require("packer.load")({'nvim-bqf'}, { event = "BufNew *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'which-key.nvim', 'dressing.nvim', 'toggleterm.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-lastplace', 'leap.nvim', 'vim-bookmarks', 'nvim-bqf', 'todo-comments.nvim', 'Comment.nvim', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

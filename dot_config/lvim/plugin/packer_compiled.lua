...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-bookmarks', 'gitsigns.nvim', 'todo-comments.nvim', 'leap.nvim', 'nvim-bqf', 'nvim-lastplace', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

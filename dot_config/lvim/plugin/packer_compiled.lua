...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'leap.nvim', 'vim-bookmarks', 'fidget.nvim', 'todo-comments.nvim', 'Comment.nvim', 'gitsigns.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]

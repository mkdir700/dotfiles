...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'nvim-lastplace', 'Comment.nvim', 'vim-bookmarks', 'gitsigns.nvim', 'todo-comments.nvim', 'leap.nvim', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

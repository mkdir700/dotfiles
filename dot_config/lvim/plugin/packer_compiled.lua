...
_G.packer_plugins = {
  ...
  ["lsp-lens.nvim"] = {
    ...
    loaded = true,
    path = "/Users/mark/.local/share/lunarvim/site/pack/packer/start/lsp-lens.nvim",
...
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-cool', 'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'toggleterm.nvim', 'bufferline.nvim', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'nvim-bqf', 'gitsigns.nvim', 'fidget.nvim', 'todo-comments.nvim', 'vim-bookmarks', 'Comment.nvim', 'leap.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

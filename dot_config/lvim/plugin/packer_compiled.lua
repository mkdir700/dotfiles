...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'nvim-bqf', 'Comment.nvim', 'nvim-lastplace', 'leap.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'vim-bookmarks'}, { event = "BufRead *" }, _G.packer_plugins)]]

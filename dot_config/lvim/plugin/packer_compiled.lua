...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-bookmarks', 'todo-comments.nvim', 'leap.nvim', 'gitsigns.nvim', 'nvim-lastplace', 'fidget.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]

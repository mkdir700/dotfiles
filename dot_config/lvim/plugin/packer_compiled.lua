...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-lastplace', 'vim-bookmarks', 'Comment.nvim', 'leap.nvim', 'todo-comments.nvim', 'nvim-bqf', 'fidget.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'vim-bookmarks', 'leap.nvim', 'nvim-lastplace', 'Comment.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'which-key.nvim', 'bufferline.nvim', 'toggleterm.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

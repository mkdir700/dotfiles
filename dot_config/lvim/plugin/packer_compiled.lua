...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-bookmarks', 'fidget.nvim', 'todo-comments.nvim', 'leap.nvim', 'nvim-bqf', 'Comment.nvim', 'nvim-lastplace'}, { event = "BufRead *" }, _G.packer_plugins)]]

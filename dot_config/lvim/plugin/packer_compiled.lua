...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-bookmarks', 'gitsigns.nvim', 'leap.nvim', 'fidget.nvim', 'todo-comments.nvim', 'Comment.nvim', 'nvim-lastplace', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]

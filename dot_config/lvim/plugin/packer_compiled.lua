...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'nvim-lastplace', 'Comment.nvim', 'leap.nvim', 'nvim-bqf', 'fidget.nvim', 'vim-bookmarks'}, { event = "BufRead *" }, _G.packer_plugins)]]

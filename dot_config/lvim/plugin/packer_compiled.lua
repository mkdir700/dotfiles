...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lastplace', 'todo-comments.nvim', 'nvim-bqf', 'vim-bookmarks', 'fidget.nvim', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

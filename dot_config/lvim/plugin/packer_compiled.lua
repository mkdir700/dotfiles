...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'nvim-lastplace', 'nvim-bqf', 'gitsigns.nvim', 'vim-bookmarks', 'Comment.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'toggleterm.nvim', 'bufferline.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

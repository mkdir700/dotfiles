...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'fidget.nvim', 'nvim-lastplace', 'vim-bookmarks', 'leap.nvim', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'toggleterm.nvim', 'dressing.nvim', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
